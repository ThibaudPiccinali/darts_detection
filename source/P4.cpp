...
int main() {
    ...
    diff_image_cam1 = cv::imread("tests/diff_image_cam1.png");
    diff_image_cam2 = cv::imread("tests/diff_image_cam2.png");
    ...
    std::vector<double> coords = get_coord_dart(diff_image_cam1,diff_image_cam2);
