...
int main() {
    ...
    base_image_cam1_colors = cv::imread("test/base_image_cam1_colors.png");
    base_image_cam2_colors = cv::imread("test/base_image_cam2_colors.png");
    dart_image_cam1_colors = cv::imread("test/dart_image_cam1_colors.png");
    dart_image_cam2_colors = cv::imread("test/dart_image_cam2_colors.png");
    ...
    std::array<double, 2> coords = get_coord_dart(diff_image_cam1,diff_image_cam2);
