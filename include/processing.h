...
cv::Mat triangulate_point(const cv::Mat& K1, const cv::Mat& K2, const cv::Mat& R1, const cv::Mat& T1,const cv::Mat& R2, const cv::Mat& T2, const cv::Point2f& pt1, const cv::Point2f& pt2);
